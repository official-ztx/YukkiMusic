...
LOG_GROUP_ID = int(getenv("-1002252184024", ""))


# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "7038202445").split())
...
START_IMG_URL = getenv(
    "START_IMG_URL",
    "https://envs.sh/AJT.jpg",  # This is the file id of the photo you can also put the url of photo
)
...
GLOBAL_IMG_URL = getenv(
    "GLOBAL_IMG_URL",
    "https://envs.sh/AJ_.jpg",
)

STATS_IMG_URL = getenv(
    "STATS_IMG_URL",
    "https://envs.sh/AJA.jpg",
)
